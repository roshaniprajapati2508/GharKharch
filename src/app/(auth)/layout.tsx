...
export default function AuthLayout({ children }: { children: React.ReactNode }) {
  return (
    ...
    <MotionConfig reducedMotion="user">
      <div className="flex min-h-dvh flex-col items-center justify-between bg-gradient-to-b from-brand-mint to-brand-cream px-5 py-8 sm:py-10">
        ...
        <FooterCredit className="mt-8 shrink-0" />
      </div>
    </MotionConfig>
  );
}
