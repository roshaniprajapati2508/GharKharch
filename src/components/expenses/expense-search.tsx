    ...
    async function run() {
      ...
      const enriched: EnrichedExpense[] = (data ?? []).map((e) => {
        ...
        return {
          ...
          // Search results don't join recurring_expenses (a rare filter path, not worth another round trip) — the row still shows the badge via recurring_rule_id, just without the rule's name in the tooltip.
